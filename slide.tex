% 上海海事大学 Beamer 主题模板
% Shanghai Maritime University Beamer Theme

% 作者主要参考：
% https://github.com/lwDavid/ShanghaiTech-Beamer-Theme/tree/main
% 颜色方案来自于官方：https://scm.shmtu.edu.cn/photo/
...
\author{姓名}
\title{Shanghai Maritime University Beamer Theme}
\subtitle{毕业设计开题报告}
\institute{上海海事大学 物流科学与工程研究院}
\date{2023年10月14日}
\usepackage{SHMTU_Macro}

% defs

\definecolor{shmtu-color}{rgb}{0,0.12549,0.631373}  %RGB#A70007
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            ...
            {pic/Shanghai_Maritime_University_Logo.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{为什么使用Beamer}
    \begin{itemize}[<+-| alert@+>] % 除使用alert，也可手动插入 \pause
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/Shanghai_Maritime_University_Logo.eps}
        \caption{这个校徽就是矢量图}
    \end{figure}
\end{frame}
